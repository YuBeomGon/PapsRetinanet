...
parser.add_argument('--saved_dir', default='./saved_models/classification', type=str, help='directory for model checkpoint')


class PapsClsModel(LightningLite) :
    ...
    def init (self, args) :
        ...
        self.model = timm.create_model(self.arch, num_classes=self.num_classes, global_pool='')
        
        if os.path.isfile(args.saved_dir + '../detection/best_model.ckpt') :
            # load pretrained model from detection
            pass
